// We probably won't go this route at first. Using cmd refresh
...
pub enum Error {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "openssl_tls")))]
        ...
        match self.provider.get_token(&self.scopes) {
            Ok(TokenOrRequest::Request {
                ...
                let https = hyper_openssl::HttpsConnector::new()
                    .map_err(Error::CreateOpensslHttpsConnector)?;
                #[cfg(all(not(feature = "openssl_tls"), feature = "native_tls"))]
                let https = hyper_tls::HttpsConnector::new();
                #[cfg(all(
                    not(any(feature = "openssl_tls", feature = "native_tls")),
                    feature = "rustls_tls"
                ))]
